## file: server/app.py (Versi Final untuk Deployment Terpisah)
...
# dan server lokal untuk pengembangan.
cors = CORS(app, resources={
  r"/*": {
    "origins": [
      "http://127.0.0.1:5500",  # Untuk development lokal (VS Code Live Server)
      "http://localhost:5500",   # Juga untuk development lokal
      "https://building-process-ochre.vercel.app/" # <<< GANTI DENGAN URL VERCEL ANDA
    ]
  }
})
# ===============================================
