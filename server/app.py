...
def check_status():
    ...
    try:
        ...
        # Ini akan menangkap error dari gspread dan mengirim pesan yang lebih jelas
        traceback.print_exc()
        error_message = f"Server error while checking status: {str(e)}. Please check for empty or duplicate headers in your 'Form2' sheet."
