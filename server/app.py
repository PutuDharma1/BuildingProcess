## file: server/app.py (Final Deployment Version)
...
CORS(app, resources={
  r"/*": {
    "origins": [
      ...
      "https://building-process-git-main-building-developments-projects.vercel.app" # YOUR VERCEL URL
    ]
  }
})
# =======================================
...
def submit_form():
    ...
    try:
        ...
        if not cabang:
             raise Exception(f"Field 'Cabang' is empty. Cannot find Coordinator.")
        ...
        # Use the Render URL for approval links
        ...
        if new_row_index:
            print(f"An error occurred after appending row. Deleting row {new_row_index}...")
...
def handle_approval():
    ...
    # Use Render URL for assets in response pages
...
if __name__ == '__main__':
    ...
    # On Render, it uses the gunicorn start command
